...
<pattern id="image1" x="0" y="0" patternContentUnits="objectBoundingBox" height="100%" width="100%">
    <image height="1" weight="1" preserveAspectRatio="none" href={require('./green-leaf.png')}>
    </image>
</pattern>
<pattern id="image2" x="0" y="0" patternContentUnits="objectBoundingBox" height="100%" width="100%">
    <image height="1" weight="1" preserveAspectRatio="none" href={require('./red-leaf.png')}>
    </image>
</pattern>
